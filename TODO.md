...
- [ ] le candidature arrivate a Daniela devono essere filtrabili per posizione e sede


### 🔍 Pagina Ricerca P[Register.kt](app/src/main/java/com/example/superspan/Register.kt)rodotti e pagina Prodotto
