...
val ListOfProduct = mutableStateListOf<Product>(
    ...
    Product("Prosciutto Crudo 100g", 2.99f, R.drawable.prosciutto_crudo, Category.SALUMI, "Prosciutto crudo stagionato di Alta Qualità affettato fresco. Coscia di suino selezionata, stagionata lentamente per esaltarne la dolcezza e la morbidezza. Senza glutine.", "Coscia di suino (85%), acqua, sale, destrosio, aromi, antiossidante: ascorbato di sodio, conservante: nitrito di sodio."),
    ...
    Product("Salsiccia Secca 100g", 3.59f, R.drawable.salsiccia_secca, Category.SALUMI, "Salame stagionato dal gusto speziato e aromatico, perfetto per antipasti e taglieri gourmet. Consistenza morbida e profumo intenso, risultato di un'accurata stagionatura traditionale. Perfetto da gustare in purezza o abbinato a formaggi stagionati.", "Carne di suino, sale, aromi naturali, spezie, destrosio, antiossidante: ascorbato di sodio, conservante: nitrito di sodio."),
    Product("Salame Ungherese 100g", 2.99f, R.drawable.salame_ungherese, Category.SALUMI, "Salame stagionato dal gusto speziato e aromatico, perfetto per antipasti e taglieri gourmet. Consistenza morbida e profumo intenso, risultato di un'accurata stagionatura traditionale. Perfetto da gustare in purezza o abbinato a formaggi stagionati.", "Carne di suino, sale, aromi naturali, spezie, destrosio, antiossidante: ascorbato di sodio, conservante: nitrito di sodio."),
